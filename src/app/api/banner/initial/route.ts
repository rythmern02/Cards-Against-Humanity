...
export async function POST(req: NextRequest) {
  try {
    ...
    // Create an SVG with embedded font and the text
    const svgImage = `
    <svg width="800" height="800" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <style>
          @font-face {
            font-family: 'SimpleFontSans';
            src: url("data:application/font-woff;charset=utf-8;base64,") format('woff');
          }
        </style>
      ...
      <text x="400" y="200" font-size="40" font-family="SimpleFontSans, sans-serif" font-weight="bold" fill="white" text-anchor="middle">
        <tspan x="400" dy="0">${escapeXml(question)}</tspan>
      </text>
      <text x="400" y="350" font-size="36" font-family="SimpleFontSans, sans-serif" fill="#34c759" text-anchor="middle">
        <tspan x="400" dy="0">${escapeXml(option1)}</tspan>
      </text>
      <text x="400" y="450" font-size="36" font-family="SimpleFontSans, sans-serif" fill="#ff9500" text-anchor="middle">
        <tspan x="400" dy="0">${escapeXml(option2)}</tspan>
      </text>
      <text x="400" y="550" font-size="36" font-family="SimpleFontSans, sans-serif" fill="#ff2d55" text-anchor="middle">
        <tspan x="400" dy="0">${escapeXml(option3)}</tspan>
      </text>
    </svg>`;

    console.log("SVG Content:", svgImage);
