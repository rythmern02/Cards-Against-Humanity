    ...
    <main className="min-h-screen bg-gray-900 text-white overflow-x-hidden">
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center">
          <h1 className={`${robotoSlab.className} text-6xl md:text-8xl font-bold mb-4 animate-pulse`}>
            Cards Against Humanity
          </h1>
          <p className={`${robotoMono.className} text-2xl md:text-4xl mb-8 animate-bounce`}>
      ...
      <section className="py-20 px-4 md:px-0">
        <div className="container mx-auto">
          <h2 className={`${robotoSlab.className} text-4xl md:text-5xl font-bold mb-12 text-center`}>
            Play Anytime, Anywhere!
          </h2>
          <div className="flex justify-center space-x-8">
            {['X', 'DSCVR', 'Blinks Explorer', 'Social Explorer'].map((platform, index) => (
              <motion.div
                key={platform}
      ...
      <section className="py-20 bg-gray-800">
        <div className="container mx-auto px-4 md:px-0">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center space-y-8 md:space-y-0 md:space-x-8">
            {['Choose Task', 'Provide Proof', 'Mint NFT', 'Rate Experience'].map((step, index) => (
              <div
                key={step}
              ...
              >
                <h3 className={`${robotoMono.className} text-2xl font-bold mb-4`}>{step}</h3>
                <p className="text-gray-300 mb-4">Step {index + 1}: {step}</p>
        ...
        <div className="container mx-auto px-4 md:px-0">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[
              ...
              >
                <h3 className={`${robotoMono.className} text-2xl font-bold mb-4`}>Task {index + 1}</h3>
      ...
      <section className="py-20 bg-gray-800">
        <div className="container mx-auto px-4 md:px-0 text-center">
          <h2 className={`${robotoSlab.className} text-4xl md:text-5xl font-bold mb-8`}>
